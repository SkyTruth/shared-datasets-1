...
def assert_protected_terraform_readiness_workflow(testcase: unittest.TestCase) -> dict:
    ...
    testcase.assertEqual(
        set(trigger["pull_request"]["paths"]),
        {
            ...
            ".github/workflows/storage-hardening-sync.yml",
            ".github/workflows/terraform-state-migration.yml",
            ".github/workflows/terraform-state-legacy-cleanup.yml",
            ...
            "scripts/terraform_state_backend_guard.py",
            "scripts/terraform_state_migrate.sh",
            ...
            "terraform/envs/prod/terraform_state_storage.tf",
    ...
    def test_pmtiles_cdn_sync_has_explicit_resource_change_allowlist(self):
        workflow = assert_protected_terraform_sync(
            ...
            expected_targets={
                ...
                "google_storage_managed_folder_iam_member.shared_bucket_cdn_fill_object_viewers",
                "google_storage_managed_folder_iam_member.shared_dataset_consumer_object_viewers",
            },
            blocked_resources={
