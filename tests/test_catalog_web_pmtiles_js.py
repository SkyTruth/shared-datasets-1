    ...
    def test_release_metadata_sidecars_drive_inspector_and_colorization(self):
        ...
        assert_contains_all(
            ...
            (
                ...
                "const FEATURE_METADATA_ID_VALUE_RE =",
                "const lookupFeatures = features.slice(0, FEATURE_METADATA_INTERACTIVE_LOOKUP_LIMIT)",
                "metadataLookupSkipped: true",
                "Metadata lookup skipped for this overlapping hit; zoom in or click a more precise point.",
                "function featureMetadataSkippedLookupCount",
                "function showFeatureMetadataLimitToast",
                "Showing metadata for the first ${FEATURE_METADATA_INTERACTIVE_LOOKUP_LIMIT}",
                ...
                "function featureIdFromMetadataLine",
                "feature metadata sidecar line ${lineNumber} is missing a valid feature_id",
