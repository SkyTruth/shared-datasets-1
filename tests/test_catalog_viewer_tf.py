...
class CatalogViewerTerraformTests(unittest.TestCase):
    def test_catalog_viewer_cloud_run_is_iap_protected_and_read_only(self):
        ...
        self.assertIn("google_cloud_run_v2_service.catalog_viewer.uri", catalog_viewer_tf)
        ...
        self.assertIn("google_secret_manager_secret.pmtiles_cdn_signed_request_key.id", catalog_viewer_tf)
        self.assertIn('"CATALOG_VIEWER_CDN_SIGNING_SECRET_VERSION"', catalog_viewer_tf)
