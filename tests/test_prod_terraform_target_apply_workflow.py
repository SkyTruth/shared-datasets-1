    ...
    def test_preview_terraform_iam_sync_caller_blocks_deletes(self):
        assert_target_apply_caller(
            ...
            expected_targets={
                ...
                "google_project_iam_custom_role.preview_iap_terraform",
                "google_storage_bucket.feature_preview",
                ...
                "google_project_iam_member.github_actions_preview_iap_terraform",
                "google_service_account_iam_member.github_actions_preview_service_act_as",
                "google_service_account_iam_member.github_actions_preview_loader_act_as",
