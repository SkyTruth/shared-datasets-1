...
license: "UNEP-WCMC General Data License (excluding WDPA); contextual internal use with citation only; no redistribution without permission"
---
...
**Source:** UNEP-WCMC, WorldFish Centre, WRI, and TNC Global Distribution of Coral Reefs v4.1  
**License / terms:** UNEP-WCMC General Data License (excluding WDPA). Use as a cited contextual layer only; do not redistribute without permission from UNEP-WCMC.
...
| File | Purpose |
|---|---|
| `latest/global-coral-reefs.fgb` | Canonical polygon FlatGeobuf layer |
| `latest/global-coral-reefs-points.fgb` | Companion point FlatGeobuf layer from the source package |
| `latest/global-coral-reefs.pmtiles` | Web map tiles with polygon and point layers |
| `releases/YYYY-MM-DD/global-coral-reefs.fgb` | Dated canonical polygon release |
