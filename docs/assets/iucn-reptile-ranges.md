...
citation: IUCN (2025). The IUCN Red List of Threatened Species. Version 2025-2. https://www.iucnredlist.org. Accessed 2026-05-03.
...
data_profile:
  ...
  identity_candidates:
  - field: id_no
    distinct_values: 10116
    duplicate_value_count: 1867
    duplicate_row_count: 5803
    status: non_unique
...
- **Citation:** IUCN (2025). The IUCN Red List of Threatened Species. Version 2025-2. https://www.iucnredlist.org. Accessed 2026-05-03. For species-level map use, cite the source feature-level citation values.
